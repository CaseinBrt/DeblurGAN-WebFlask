...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--loadSizeX', type=int, default=None, help='scale images to this width (if None, use original width)')
		self.parser.add_argument('--loadSizeY', type=int, default=None, help='scale images to this height (if None, use original height)')
		self.parser.add_argument('--fineSize', type=int, default=None, help='crop to this size (if None, no cropping)')
		...
		self.parser.add_argument('--name', type=str, default='/home/janadal/DeblurGAN3/app/checkpoints/experiment_name', help='name of the experiment. It decides where to store samples and models')
		...
		self.parser.add_argument('--checkpoints_dir', type=str, default='/home/janadal/DeblurGAN3/app/checkpoints', help='models are saved here')
